...
metadata:
  hermes:
    tags: [Excalidraw, Diagrams, Flowcharts, Architecture, Visualization, JSON, SVG-Diagrams]
...
For generating professional dark-themed SVG architecture/cloud/infra diagrams as standalone HTML (not hand-drawn style), see `references/architecture-diagram-reference.md`. This companion guide covers:

- Color palette mapping for frontend, backend, database, cloud, security components
- Connection rules with arrowheads and dashed security flows
- Layout, spacing, and info card patterns
- Full HTML template structure with SVG grid backgrounds
