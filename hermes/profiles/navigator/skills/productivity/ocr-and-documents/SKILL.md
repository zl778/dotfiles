...
description: "Extract text from PDFs/scans (pymupdf, marker-pdf) and edit PDF text via nano-pdf."
version: 2.4.0
author: Hermes Agent
license: MIT
...
## Editing PDF Text with nano-pdf

For editing PDFs using natural-language instructions:
